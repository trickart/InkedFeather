// elf2image.swift — ELF to ESP32-C3 flash image converter
// Usage: swift elf2image.swift --flash_mode dio --flash_freq 80m --flash_size 16MB -o out.bin input.elf
...
let IMAGE_CHIP_ID: UInt16 = 5   // ESP32-C3
...
func printUsage() -> Never {
    ...
    Options:
      ...
      --flash_size  <size>   1MB, 2MB, 4MB, 16MB, ... (default: 16MB)
